...
Public Class REGISTRO_DE_EMPRESA
            ...
            If txtRuta.Text <> "" Then
                ...
                If txtcaja.Text <> "" Then
                    Try
                        ...
                        cmd.CommandType = 4
                        cmd.Parameters.AddWithValue("@descripcion", txtcaja.Text)
                        cmd.Parameters.AddWithValue("@Tema", "Elegante Black")
    ...
    Sub insertar_datos_POR_DEFECTO()
        Try
            Dim cmd As New SqlCommand
            abrir()
            ...
            abrir()
            cmd = New SqlCommand("insertar_Areas_De_impresion", conexion)
            cmd.CommandType = 4
            cmd.Parameters.AddWithValue("@Area", "Impresora para Envios de Pedidos")
            cmd.ExecuteNonQuery()
            Cerrar()
            ...
            cmd = New SqlCommand("insertar_Areas_De_impresion", conexion)
            cmd.CommandType = 4
            cmd.Parameters.AddWithValue("@Area", "Impresora para Pre-cuenta")
            cmd.ExecuteNonQuery()
            Cerrar()
            ...
            cmd = New SqlCommand("insertar_Areas_De_impresion", conexion)
            cmd.CommandType = 4
            cmd.Parameters.AddWithValue("@Area", "Impresora para CAJA")
            cmd.ExecuteNonQuery()
            Cerrar()
            ...
            cmd = New SqlCommand("insertar_Areas_De_impresion", conexion)
            cmd.CommandType = 4
            cmd.Parameters.AddWithValue("@Area", "Impresora para Reportes")
            cmd.ExecuteNonQuery()
            Cerrar()
        Catch ex As Exception
    ...
    Private Sub txtmoneda_SelectedIndexChanged(sender As Object, e As EventArgs) Handles txtmoneda.SelectedIndexChanged

...
Public Class Cierre_de_turno
    ...
    Private Sub Label11_Click(sender As Object, e As EventArgs) Handles Label11.Click
        If txthay.Text = "" Then
            MessageBox.Show("Ingresa cuanto tienes en Caja", "Faltan datos", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Else
            Timer1.Start()
        End If
    ...
    Sub editar_estado_de_caja()
        Try
            ...
            cmd.Parameters.AddWithValue("@estado", "Caja Cerrada")
